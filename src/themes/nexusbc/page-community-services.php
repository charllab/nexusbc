            ...
            <div class="form-row align-items-center">
                <div class="col-md-8 col-lg-10">
                    <fieldset class="group">
                        <input class="form-control rounded-0 w-100 mb-150 mb-md-0" type="text" id="search-keyword"
                               name="search-keyword" placeholder="Type here…">
                    </fieldset>
                </div><!-- col -->
...
?>
    <div class="mb-2 print-section" id="<?php echo strtolower(str_replace(' ', '', get_the_title())); ?>">
        <h2><?php the_title(); ?> <a href="#"
                                     onclick="printDiv('<?php echo strtolower(str_replace(' ', '', get_the_title())); ?>'); return false;"><i
                    class="ml-250 fa fa-print fa-sm"></i></a></h2>
        ...
        <p class="mb-0"><b>Tel</b>: <a
                href="tel:<?php the_field('phone_number'); ?>"><?php the_field('phone_number'); ?></a></p>

        <?php if (get_field('email_address')): ?>
            <p class="mb-0"><b>Email</b>: <a
                    href="mailto:<?php the_field('email_address'); ?>"><?php the_field('email_address'); ?></a></p>
        <?php endif; ?>
